...
<!-- openscad -o docs/images/jig-main.png --backend=CGAL --camera=0,0,0,40,0,10,200 -D part='"jig"' mag_insert_jig.scad -->
<!-- openscad -o docs/images/jig-pusher.png --backend=CGAL --camera=0,0,0,40,0,10,200 -D part='"pusher"' mag_insert_jig.scad -->
<!-- openscad -o docs/images/jig-main-below.png --backend=CGAL --camera=0,0,0,140,0,10,200 -D part='"jig"' mag_insert_jig.scad -->
<!-- openscad -o docs/images/jig-pusher-below.png --backend=CGAL --camera=0,0,0,140,0,10,200 -D part='"pusher"' mag_insert_jig.scad -->
